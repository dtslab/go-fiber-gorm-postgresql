...
import (
	"fmt"
	"go-fiber-gorm-postgresql/models"
	"go-fiber-gorm-postgresql/storage"
	"log"
	"net/http"
	"os"
...
// still have a problem with connecting to db. File include .env & postgres.go
// Golang With PostgresQL - REST API (GO-Fiber)
// https://www.youtube.com/watch?v=0dtidtzKRD4&list=PL5dTjWUk_cPaKHFvmMct_VG5vIU4piYv4&index=6